#ifndef BEARMUNDO_SECURITY_STATE_ANALYZER_ADVANCED_H
#define BEARMUNDO_SECURITY_STATE_ANALYZER_ADVANCED_H
...
#endif // BEARMUNDO_SECURITY_STATE_ANALYZER_ADVANCED_H 